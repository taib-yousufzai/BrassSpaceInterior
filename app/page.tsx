      ...
      <section className="bg-white py-20 relative overflow-hidden text-gray-800">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {/* Team Members */}
            <StaggerItem>
              <div className="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2 h-full flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 group-hover:text-[#daa520] transition-colors duration-300">{SITE_CONFIG.stats.team}</h3>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider">Team Members</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2 h-full flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 group-hover:text-[#daa520] transition-colors duration-300">{SITE_CONFIG.stats.projects}</h3>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider">Projects Delivered</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2 h-full flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 group-hover:text-[#daa520] transition-colors duration-300">{SITE_CONFIG.stats.experience}</h3>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider">Years of Experience</p>
              </div>
            </StaggerItem>
            ...
            <StaggerItem>
              <div className="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2 h-full flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2 group-hover:text-[#daa520] transition-colors duration-300">{SITE_CONFIG.stats.cities}</h3>
                <p className="text-gray-500 text-sm font-semibold uppercase tracking-wider">Cities Present</p>
              </div>
            </StaggerItem>
          </StaggerContainer>
        </div>
