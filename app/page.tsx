      ...
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {/* Google Rating Card */}
            <StaggerItem>
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2">
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#daa520]/20 to-[#b8860b]/20 group-hover:from-[#daa520] group-hover:to-[#b8860b] flex items-center justify-center mx-auto mb-4 transition-all duration-300">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-[#daa520] transition-colors duration-300">4.8 Google Rating</h3>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-[#daa520] transition-colors duration-300">150+ Projects</h3>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-[#daa520] transition-colors duration-300">On-Time Delivery</h3>
              <p className="text-gray-400 text-sm">100% Track Record</p>
            </div>
            </StaggerItem>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8 shadow-lg hover:shadow-2xl hover:border-[#daa520] transition-all duration-300 text-center group hover:-translate-y-2">
              ...
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-[#daa520] transition-colors duration-300">Transparent Pricing</h3>
      ...
      <section className="py-16 bg-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <FadeInUp className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">Design tips, trends, and inspiration</p>
          </FadeInUp>
